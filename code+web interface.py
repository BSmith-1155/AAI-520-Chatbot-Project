...
!pip install gradio                 # Install gradio and other necessary packages in the environment

pip install starlette==0.14.2  # This is an example version; you might need to try a few to find a compatible one
...
demo = gr.Interface(fn=respond, inputs=gr.inputs.Chatbox(), outputs="text")
